...
export default function Tooltip() {
    ...
    return (
        ...
        >
            ...
            />
            <div className={cn(
                "absolute bg-slate-800 hidden left-1/2 px-2 py-3 rounded-xs text-[8px] [text-box:trim-both_cap_alphabetic] text-white top-[calc(100%+16px)] -translate-x-1/2 w-30",
