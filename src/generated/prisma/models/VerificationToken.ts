...
export type VerificationTokenOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"expires" | "identifier" | "token", ExtArgs["result"]["verificationToken"]>
...
export interface VerificationTokenDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * })
   * 
   * // Create many VerificationTokens and only return the `expires`
   * const verificationTokenWithExpiresOnly = await prisma.verificationToken.createManyAndReturn({
   *   select: { expires: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more VerificationTokens and only return the `expires`
   * const verificationTokenWithExpiresOnly = await prisma.verificationToken.updateManyAndReturn({
   *   select: { expires: true },
   *   where: {
   *     // ... provide filter here
   *   },
